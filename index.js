...
function fazerPerguntas() {
    if (inputPergunta.value == "") {
        ...
        const qtdtotalRespostas = respostaZero.length;
        const numeroAleatorio = Math.floor(Math.random() * qtdtotalRespostas)

        elementoResposta.innerHTML = respostaZero[numeroAleatorio]
